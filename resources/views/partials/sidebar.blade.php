 ...
 <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{($title == "Indikator Unit Kerja" || $title == "Data User" || $title == "Unit Kerja") ? "" : "collapsed"}}" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
        ...
        <ul id="components-nav" class="nav-content {{($title == "Beranda") ? "collapse" : ""}}" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="\indikator" class="{{($title == "Indikator Unit Kerja") ? "active" : ""}}">
