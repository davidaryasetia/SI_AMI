              ...
              <div class="card">
                  <div class="card-body">
                      <div class="d-flex align-items-center ml-0">
                          <a href="/data_audit/data_user_pengguna/" type="" class="ms-2"><i class="ri-arrow-left-line" style="font-size: 26px; color: #012970"></i></a>
                          <h5 class="card-title ms-3">Tambah Data User Pengguna</h5>
                      </div>
                      <div class="col-lg-12">
                          <form action="/data_audit/data_user_pengguna/" method="post" enctype="multipart/form-data" class="row g-3">
                              @csrf
                              <div class="col-md-6">
                                  <label for="nama_lengkap" class="form-label">Nama Lengkap</label>
                                  <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap" id="nama_lengkap" placeholder="Masukkan Nama Lengkap" required autofocus>
                                  @error('nama_lengkap')
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input type="string" class="form-control @error('nip') is-invalid @enderror" name="nip" id="nip" placeholder="Masukkan NIP" required>
                                  @error('nip')
                                  <div class="alert alert-danger mt-2">
                                      {{$message}}
                                  </div>
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input type="string" class="form-control @error('no_telepon') is-invalid @enderror" name="no_telepon" id="no_telepon" placeholder="Masukkan Nomor Telepon" required>
                                  @error('no_telepon')
                                  <div class="alert alert-danger mt-2">
                                      {{$message}}
                                  </div>
                              ...
                              <div class="col-md-6">
                                  ...
                                  <select id="unit_id" name="unit_id" class="form-select" required>
                                    ...
                                    <option value="{{$unit->unit_id}} selected">{{$unit->nama_unit}}</option>
                                    @else
                           ...
                           <hr>
                            ...
                            <div class="col-md-6">
                              ...
                              <hr>
                              <div class="">
                                  <button type="submit" class="btn btn-primary"><i class="ri-check-fill"> Submit</i></button>
                                  <a href="/data_audit/data_user_pengguna/" type="" class="btn btn-danger ms-2"><i class="ri-close-fill"> Cancel</i></a>
                              </div>
                          </form>
                      </div>
                  </div>
