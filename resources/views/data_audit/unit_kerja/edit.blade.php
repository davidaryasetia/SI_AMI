                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <a href="/data_audit/unit_kerja/" type="" class="ms-2"><i
                                        class="ri-arrow-left-line" style="font-size: 20px; color: #012970"></i></a>
                                ...
                                <form action="/data_audit/unit_kerja/{{ $unit->nama_unit }}" method="post" class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control @error('nama_unit') is-invalid @enderror"
                                            name="nama_unit" id="nama_unit" placeholder="Masukkan Nama Unit" required
                                            autofocus value="{{ old('nama_unit', $unit->nama_unit) }}">
                                        @error('nama_unit')
